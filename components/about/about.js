                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12 col-12 order-lg-1 order-2">
                            <div className="wpo-about-text">
                                ...
                                <p className='ff' style={{fontSize:'25px'}} >THEPLUG WEDDING 
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-12 col-12">
                            <div className="wpo-about-text">
                                ...
                                <p style={{fontSize:'25px',textAlign:'justify', fontFamily:'Montserrat'}}>Hey 😊, <br/>
Making-off section
                                </p>
                                <Link style={{backgroundColor:'#b99256'}} onClick={ClickHandler} href="/contact" className="theme-btn">APPOINMENT</Link>
                            </div>
