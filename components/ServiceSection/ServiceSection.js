                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12" key={sitem}>
                                ...
                                {/* <div className="wpo-Service-item item-service">
                                    <ul className="list-item">
                                        <li className="item">Description : 1</li>
                                        <li className="item">Description : 2</li>
                                        <li className="item">Description : 3</li>
                                    </ul>
                                    <br />
                                    <Link style={{backgroundColor:'#b99256', alignItems: 'center', marginLeft: '17px'}} onClick={ClickHandler} href='/service/[slug]' as={`/service/${service.slug}`} className="theme-btn">SEE MORE...</Link>
                                </div> */}
                            </div>
                        ))}
