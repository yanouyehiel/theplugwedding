                            ...
                            <div className="col-lg-2 col-md-6 col-6 d-lg-block d-none">
                                <div>
                                    <ul className="icon-color">
                                        <li className='icon'><Link style={{color:'#B99226'}}  target={'_blank'} href="tel:+4915752069252"><i className="fi flaticon-phone-call"></i></Link>Phone</li>
                                    {/* <li><Link href="/"><i className="fi flaticon-twitter"></i></Link></li>*/}
                                        <li className='icon'><Link style={{color:'#B99226'}} target={'_blank'} href="mailto:contact@theplug-group.com"><i className="fi flaticon-email icon"></i></Link>Email</li>
                                ...
                                <div className="header-right">
                                    ...
                                    <div>
                                        ...
                                        {/* <li><Link href="/"><i className="fi flaticon-twitter"></i></Link></li>*/}
                                            ...
                                            <li><Link style={{color:'#B99226'}} target={'_blank'}href="https://www.instagram.com/theplug_wedding/"><i className="fi flaticon-instagram-1"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
