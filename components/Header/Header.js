                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-6 col-6 d-lg-none dl-block">
                                <div className="navbar-header">
                                    <Link className="navbar-brand" href="/"><img src='/images/logo-mobile.png' alt="" /></Link>
                                </div>
                            </div>
...
<li className="menu-item-has-children">
                                            <Link className='item-menu' href="/portfolio-masonary" style={{cursor: 'default'}}>Portfolio</Link>
                                            <ul className="sub-menu">
                                                ...
                                                <li><Link onClick={ClickHandler} href='/portfolio-masonary-s3'>Portraits</Link></li>
                                                <li><Link onClick={ClickHandler} href='/portfolio-masonary'>Weddings</Link></li>
                                                <li><Link onClick={ClickHandler} href='/portfolio-masonary-s2'>Events</Link></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><Link className='item-menu' onClick={ClickHandler} href="/videos">Videos</Link></li>
